...
Signavio.I18N.fr = "Fran鏰is";
Signavio.I18N.ru = " CAA:89";
Signavio.I18N.es = "Espa駉l";
...
Signavio.I18N.Repository.SecurityCenter.writeInfoManage = "Please use the <a href='#' class='x-manage-access'>Manage inviations to comment</a> dialog to review all invitations for this diagram.";
...
Signavio.I18N.Repository.Offer.certificateDownloadSharePointInfo = "Here you can download a preconfigured SharePoint component which you than can install to your intranet.";
...
Signavio.I18N.Repository.Administration.spreadsheetLicense = 'QuickModel <small>({count} account{[values.count == 1 ?"":"s" ]} left)</small>';
Signavio.I18N.Repository.Administration.teamLicense = 'Basis edition <small>({count} account{[values.count == 1 ?"":"s" ]} left)</small>';
Signavio.I18N.Repository.Administration.premiumLicense = 'Professional Edition <small>({count} account{[values.count == 1 ?"":"s" ]} left)</small>';
Signavio.I18N.Repository.Administration.corporateLicense = 'Corporate Edition <small>({count} account{[values.count == 1 ?"":"s" ]} left)</small>';
Signavio.I18N.Repository.Administration.trialLicense = "Trial edition";
...
Signavio.I18N.Repository.Purchase.licenseTitlePremium = 'Professional Edition <a href="http://www.signavio.com/en/products/process-editor-as-a-service.html" target="_blank">Details</a>';
...
Signavio.I18N.Repository.Purchase.quarter = "Yearly";
Signavio.I18N.Repository.Purchase.month = "Quarterly";
...
Signavio.I18N.Repository.Offer.archiveRestoreErrorDesc = "Something went wront during the upload. Please try again or contact the <a href='mailto:[supportMailAdresse]'>Support</a>.";
...
Signavio.I18N.Repository.Offer.archiveRestoreLabel = "Please select the Signavio export archive to be imported. All contents are imported into the current folder.";
...
Signavio.I18N.Repository.MetaData.Types.MetaDataEnum = "Dropdown box";
...
Signavio.I18N.Repository.MetaData.Complex.InvalidNames = "There can't be two or more columns with identical names.";
Signavio.I18N.Repository.MetaData.Complex.MoveUp = "Move up";
Signavio.I18N.Repository.MetaData.Complex.MoveDown = "Move down";
Signavio.I18N.Repository.MetaData.Complex.WrongColWidth = "The col width has to be at least 1.";
...
Signavio.I18N.Repository.MetaData.ShowAddDialog.DateFormatInfo = "Defines the format which the date is stored with, e.g. 'H:i:s d-m-Y' for hour:minute:second day-month-year.";
...
Signavio.I18N.Repository.MetaData.ShowAddDialog.InvalidFields = "The followed field(s) need(s) a value:\n'";
Signavio.I18N.Repository.MetaData.ShowAddDialog.invalidTitle = "An own attribute needs a name.";
...
Signavio.I18N.Repository.MetaData.Subsets.AddButton = "Add";
...
Signavio.I18N.Repository.Analysis.shouldWorkHoursPerDay = "Nominal value of work hours / year";
...
Signavio.I18N.Repository.MetaData.windowTitle = "Modeling conventions";
...
Signavio.I18N.Repository.MetaData.stencilsetsDescriptionText =  "Define in your work area, which stencil sets and stencils can be used for modeling by the modelers. "+
																"You can create and delete custom subsets for each chart type, the default subsets can neither be be changed nor deleted."+
																"In addition, you can add attributes to custom stencils which are available for modeling."+
...
Signavio.I18N.Repository.MetaData.noOwnAttributes = 'No own attributes are defined';
...
Signavio.I18N.Repository.Offer.BPMN2_0Import.DuplicatedId = "Duplicated ID";
Signavio.I18N.Repository.Offer.BPMN2_0Import.DuplicatedIdDetail = "Dublicated ID (#{shapeid}) at Element: #{shapeclass}";
...
Signavio.I18N.Repository.Offer.BPMN2_0Import.DuplicatedProcessId = "Duplicated ProcessID";
Signavio.I18N.Repository.Offer.BPMN2_0Import.DuplicatedIdDetail = "There was a duplicated ShapeID ({shapeid}) found. If applicable please check the attribute ShapeID.";
...
Signavio.I18N.Repository.Configuration.sharepointUrlDescription = "Before you can install the Signavio SharePoint component, you have to define the URL to the SharePoint connector service. This will be used to request available groups and users from the internal Active Directory for single sign on to the SharePoint component. If the URL changes, it has to be reconfigured here.";
...
Signavio.I18N.Repository.Configuration.Templates.grunenthalCompany = "Gr黱enthal";
...
Signavio.I18N.Repository.Configuration.Templates.windmoellerCompany = "Windm鰈ler & H鰈scher";
...
Signavio.I18N.FilterSet.relation = {
		...
		typeContains: "contains",    // TODO: ordentlich vom deutschen 黚ersetzen
		typeNotContains: "does not contain", // TODO: ordentlich vom deutschen 黚ersetzen
...
Signavio.I18N.LanguageConfiguration.moveConfirmDescription = "You are about to change the default language to #{lang}. This has a major impact for your workspace, e.g. you have resave <b>all</b> diagrams manual again to see the correct diagram preview.<br/>Please contact the <a href='mailto:#{supportMailAdresse}'>support</a> an execution code.<br/><br/><label for='x-language-change-default'>Execution code: </label><input id='x-language-change-default' type='text' style='width:50px;margin-left:10px;padding:1px 2px;' maxlength='4'><br/><br/>Do you really want to continue?";
Signavio.I18N.LanguageConfiguration.addNewTitle = "New language";
Signavio.I18N.LanguageConfiguration.addNewDescription = "You are about to activate the multi language definition for your workspace. This can not been reverted. Your first selected language will the default language for the workspace and can not been changed later.<br/>Do you want to continue?";
...
Signavio.I18N.MetaModellingGuidelines.Rules["VOS"] = "Activity verb object";
...
Signavio.I18N.ModGuidelines.errorDesc = "There were no modeling conventions爁ound. For questions please contact the Signavio Support";
