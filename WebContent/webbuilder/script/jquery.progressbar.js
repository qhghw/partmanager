	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: 'webbuilder/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'webbuilder/images/progressbg_red.gif',
									30: 'webbuilder/images/progressbg_orange.gif',
									70: 'webbuilder/images/progressbg_green.gif'
								},
