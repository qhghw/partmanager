...
<%
    File reportFile = new File(application
            .getRealPath("/jsp/ireport/OutinQuery.jasper"));
    ...
    parameters.put("storeName",  new   String((request.getParameter( "storeName")==null?"":request.getParameter( "storeName")).getBytes( "ISO8859-1"),   "UTF-8"));
   UserDTO userInfo = (UserDTO) request.getSession().getAttribute(Constants.USERINFO);
    ...
    System.out.println("-------------"+ new   String((request.getParameter( "storeName")).getBytes( "ISO8859-1"),   "UTF-8"));
	String jndi = "java:comp/env/jdbc/mysql";
    conn = DbUtil.getConnection(jndi);
    //装载jasper文件application
    File exe_rpt = new File(application.getRealPath("/jsp/ireport/OutinQuery.jasper"));
