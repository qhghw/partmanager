package com.partmanager.biz.power.dto;
...
import com.partmanager.pojo.Users;
...
public class UserDTO {
	...
	public UserDTO(Integer userid, String logincode, String password,
			String username, Integer state, String bz,String dept_cod) {
		super();
		this.userid = userid;
	...
	public static UserDTO createDto(Users pojo) {
		...
		if (pojo != null) {
			dto = new UserDTO(pojo.getUserid(), pojo.getLogincode(),
					...
					pojo.getState(),pojo.getBz(),pojo.getDept_cod());
		}
		return dto;
	}
